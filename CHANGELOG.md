...
- The combined field mask enforces the segment ranges — first digits constrained while typing (month `0-1`, day `0-3`, hour `0-2` / `0-1` in 12h, minute / second `0-5`) and a postprocessor clamps complete segments (day ≤ 31, month ≤ 12, hour ≤ 23 / 12, minute / second ≤ 59). The hour bounds follow `ampm` (1–12) vs 24-hour (0–23).
